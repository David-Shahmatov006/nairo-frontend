    ...
    <>
      ...
      >
        ...
        <div className="flex flex-1">
          ...
          <main
            className={clsx(
              "flex-1 h-full flex flex-col scrollbar-hidden max-1024px:pl-0 [@media(min-width:1024px)_and_(max-width:1339px)]:pl-[250px] min-2000px:pl-[20vw] pl-[315px] overflow-auto min-h-screen min-2000px:pt-[3.5vw]",
