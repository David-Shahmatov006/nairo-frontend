    ...
    <>
      ...
      <div className="mb-5">
        ...
        <div className="flex items-center gap-2 w-full">
          <div className="relative w-full">
            ...
            <input
              type="email"
              className="w-full pl-10 pr-10 py-2 border dark:border-white/10 border-[#E5E7EB] rounded-lg text-[15px] dark:text-white/80 text-[#111827] focus:outline-none focus:ring-2 focus:ring-main/40 duration-300"
      ...
      <div>
        ...
        <div className="flex items-center gap-2 w-full">
          <div className="relative w-full">
            <div className="absolute left-2 top-1/2 -translate-y-1/2">
              <CiLock className="text-[20px] dark:text-white/40 text-black/40" />
            </div>
            <input
              type="email"
              className="w-full pl-10 pr-10 py-2 border dark:border-white/10 border-[#E5E7EB] rounded-lg text-[15px] dark:text-white/80 text-[#111827] focus:outline-none focus:ring-2 focus:ring-main/40 duration-300"
        ...
        <button className="mt-5 min-w-[90px] font-[500] px-4 h-10 rounded-lg dark:bg-black dark:border border-white/10 bg-gray-800 text-white hover:ring-2 hover:ring-main/70 duration-300 cursor-pointer">
          {t("settings.save")}
        </button>
      </div>
    </>
