...
export const Login = () => {
  ...
  return (
    <>
      <div className="relative max-768px:max-w-full max-1024px:pt-[5%] max-w-[70%] mx-auto h-screen flex max-1024px:flex-col items-center justify-between max-768px:pb-10">
        ...
        <div className="flex max-1024px:w-[90%] w-[50%] mb-[10%] flex-col max-1024px:items-center justify-center z-[2]">
          <Logo
            iconClassName="[@media(min-width:1024px)_and_(max-width:1440px)]:size-10 size-[50px]"
            textClassName="[@media(min-width:1024px)_and_(max-width:1440px)]:text-[45px]"
          />
