...
export const LoginModal = () => {
  ...
  return (
    <div className="z-[888] w-full font-manrope bg-gradient-to-t from-[#8b53ff] to-transparent rounded-[16px] shadow-[0px_32px_64px_-12px_#10182824] p-[1.5px] relative">
