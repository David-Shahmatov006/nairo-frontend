  ...
  return (
    <div className="w-full font-manrope bg-gradient-to-t from-[#8b53ff] to-transparent rounded-[16px] shadow-[0px_32px_64px_-12px_#10182824] p-[1.5px] relative">
      <div className="bg-white p-[32px] sm:p-[48px] rounded-[16px]">
        ...
        <button className="group flex items-center justify-center gap-3 min-h-[48px] rounded-[12px] bg-gray-900 text-white w-full font-[500] cursor-pointer hover:opacity-70 duration-300">
          Log in
          <FiArrowRight className="group-hover:translate-x-[15%] duration-300" />
        </button>
        <div className="w-full flex items-center justify-center mt-10">
          <p className="hover:opacity-50 duration-300 cursor-pointer text-[16px] cursor-pointer font-[700] mb-[16px]">
            Forgot Password?
          </p>
        </div>
      </div>
